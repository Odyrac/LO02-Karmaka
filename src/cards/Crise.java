...
/**
 * Classe Crise qui implémente le pouvoir de la carte Crise
 * Permet de faire défausser à un joueur une de ses oeuvres
...
public class Crise extends Carte {
    ...
    /**
     * Ìnstancie une carte Crise avec les valeurs par défaut
     */
    public Crise() {
