...
/**
 * Classe Recyclage qui implémente le pouvoir de la carte Recyclage
 * Permet d'ajouter à sa vie future une des 3 dernières cartes de la fosse
...
public class Recyclage extends Carte {
    ...
    /**
     * Ìnstancie une carte Recyclage avec les valeurs par défaut
     */
    public Recyclage() {
