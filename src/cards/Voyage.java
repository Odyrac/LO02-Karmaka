...
/**
 * Classe Voyage qui implémente le pouvoir de la carte Voyage
 * Permet de piocher 3 cartes à la Source et de jouer une autre carte
...
public class Voyage extends Carte {
    ...
    /**
     * Ìnstancie une carte Voyage avec les valeurs par défaut
     */
    public Voyage() {
