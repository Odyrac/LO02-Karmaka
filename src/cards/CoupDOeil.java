...
/**
 * Classe CoupDOeil qui implémente le pouvoir de la carte CoupDOeil
 * Permet de regarder la main d'un joueur et de jouer une autre carte
...
public class CoupDOeil extends Carte {
    ...
    /**
     * Ìnstancie une carte CoupDOeil avec les valeurs par défaut
     */
    public CoupDOeil() {
        this.couleur = EnumCouleur.bleu;
        this.points = 1;
        this.nom = "Coup d'Oeil";
        this.description = "Regardez la game.Main d’un rival. Vous pouvez ensuite jouer une autre carte.";
    }
