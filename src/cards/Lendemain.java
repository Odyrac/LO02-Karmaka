...
/**
 * Classe Lendemain qui implémente le pouvoir de la carte Lendemain
 * Permet de piocher une carte à la source et de jouer une autre carte
...
public class Lendemain extends Carte {
    ...
    /**
     * Ìnstancie une carte Lendemain avec les valeurs par défaut
     */
    public Lendemain() {
