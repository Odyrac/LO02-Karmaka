...
/**
 * Classe Semis qui implémente le pouvoir de la carte Semis
 * Permet de piocher 2 cartes à la source et de placer 2 cartes de sa main sur sa vie future
...
public class Semis extends Carte {
    ...
    /**
     * Ìnstancie une carte Semis avec les valeurs par défaut
     */
    public Semis() {
        this.couleur = EnumCouleur.vert;
        this.points = 2;
        this.nom = "Semis";
        this.description = "Puisez 2 cartes à la Source, puis placez sur votre Vie Future 2 cartes de votre game.Main.";
    }
