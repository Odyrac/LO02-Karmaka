...
public class JoueurVirtuel extends Joueur implements Strategie {
    ...
    /**
     * Constructeur de la classe game.JoueurVirtuel.
    ...
    public int jouerAleatoire(int minVal, int nombreChoix) {
        if (minVal == nombreChoix) {
            Utils.println("[BOT] Choix du game.JoueurVirtuel : " + minVal + "/" + nombreChoix, "rose");
            return minVal;
        }
        int choix = minVal + (int) (Math.random() * (nombreChoix - minVal + 1));
        Utils.println("[BOT] Choix du game.JoueurVirtuel : " + choix + "/" + nombreChoix, "rose");
        return choix;
    }
    ...
    public int jouerDefensif(int minVal, int nombreChoix) {
        ...
        Utils.println("[BOT] Choix du game.JoueurVirtuel : " + choix, "rose");
        return choix;
    }
