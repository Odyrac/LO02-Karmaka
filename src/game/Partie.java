...
/**
 * La classe game.Partie gère le déroulement d'une partie du jeu.
...
public class Partie implements Serializable {
    ...
    // Instance unique de la classe game.Partie
    private static Partie instance;

    /**
     * Méthode statique permettant d'obtenir l'instance unique de game.Partie.
     * Si l'instance n'existe pas, elle est créée.
     * 
     * @return L'instance unique de game.Partie.
     */
    ...
    /**
     * Constructeur privé de la classe game.Partie.
     */
    private Partie() {
    ...
    public String toString() {
        String str = "";
        str += "game.Joueur actuel : " + this.getJoueurActuel().getPseudo() + "\n";
        str += "game.Joueur adverse : " + this.getJoueurAdverse(this.getJoueurActuel()).getPseudo() + "\n";
