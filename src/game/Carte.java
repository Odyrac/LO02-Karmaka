...
/**
 * La classe game.Carte représente une carte générique avec des attributs tels que le nom, la description, les points,
...
public class Carte implements Serializable {
    ...
    /**
     * La couleur de la carte, représentée par une énumération game.EnumCouleur.
     */
    protected EnumCouleur couleur;

    /**
     * Le nombre total de cartes, partagé entre toutes les instances de game.Carte.
     */
     ...
     *
     * @return L'énumération game.EnumCouleur représentant la couleur de la carte.
     */
